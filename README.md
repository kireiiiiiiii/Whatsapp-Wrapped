<img src="./public/banner.png" alt="banner" style="width: 100%;" />
...
3. **Paste the chat backup file path** This file can be exported by going to WhatsApp chat settings, then _More_ and _Export chat_.
